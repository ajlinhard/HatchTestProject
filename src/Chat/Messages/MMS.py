...
@MessageRegistry.register(MessageType.MMS)
class MMS():
    """
    MMS Provider class for sending and receiving MMS messages. 
    NOTE: with more time this could be an abstract class for MMS providers.
    """
    ...
    def send_message(self, to: str, message: str):
        ...
        Send an MMS message.
        """
        # Here you would implement the actual API call to send the MMS
